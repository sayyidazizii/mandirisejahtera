...
<h3 class="page-title">
Simpanan Berjangka Dapat Bunga
</h3>
...
if($deposito_profit_sharing_amount > $preferencecompany['tax_minimum_amount']){
	$tax_total	= $deposito_profit_sharing_amount * $preferencecompany['tax_percentage'] / 100;
}else{
	$tax_total 	= 0;
}
?>
					...
					<div class="row">
						...
						<div class="col-md-5">
							<table width="100%">
								...
								<tr>
										<td width="35%">Pajak (Rp)</td>
										<td width="5%">:</td>
										<td width="60%"><input type="text" class="easyui-textbox" name="tax_total_view" id="tax_total_view" autocomplete="off" style="width: 100%" value="<?php echo nominal($tax_total) ?>" readonly/>
