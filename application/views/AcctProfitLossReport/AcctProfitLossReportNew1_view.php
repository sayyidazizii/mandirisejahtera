...
<script>
	...
	function recalculate(){
		...
		// $.ajax({
		// 		type: "POST",
		// 		url : "<?php echo site_url('AcctRecalculateEOM/processAcctRecalculateEOM');?>",
		// 		data : {branch_id : branch_id, month_period: month_period, year_period: year_period},
		// 	// 	success: function(msg){
		// 	// }
		// });

		// $.post(base_url + 'AcctRecalculateEOM/processAcctRecalculateEOM',
		// 	{branch_id : branch_id, month_period: month_period, year_period: year_period});
	}
			...
			<div class="portlet-body">
				...
				?>
					...
					<div class="col-md-4">
						...
						<!-- <div class = "col-md-4">
							<div class="form-group form-md-line-input">
								<?php echo form_dropdown('profit_loss_report_format', $profitlossreportformat, set_value('profit_loss_report_format',$data['profit_loss_report_format']),'id="profit_loss_report_format" class="form-control select2me"');?>
									...
									<tbody>
										<tr>
											<td>
												<table class="table table-bordered table-advance table-hover">
													<?php
													// print_r($acctprofitlossreport_bottom);
														foreach ($acctprofitlossreport_top as $key => $val) {
															...
															// print_r($grand_total_account_amount1);
														}
													?>
												</table>
											</td>
