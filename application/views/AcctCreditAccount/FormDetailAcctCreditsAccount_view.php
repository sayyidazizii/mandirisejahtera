								...
								<tbody>
									...
									<?php
										...
										if($acctcreditsacquittance){ ?>
											<tr>    
												<th colspan='8' style='text-align:center'>Pelunasan</th>
											</tr>
											<tr>    
												<th colspan='2' style='text-align:center;'>Tanggal Pelunasan</th>		
												<th style='text-align:center;'>Pelunasan Pokok</th>	
												<th style='text-align:center;'>Pelunasan Bunga</th>	
												<th style='text-align:center;'>Pelunasan Sanksi</th>	
												<th style='text-align:center;'>Pinalti</th>
												<th colspan='2' style='text-align:center;'>Jumlah Pelunasan</th>
											</tr>
										<?php 
											foreach($acctcreditsacquittance as $key => $val){
												echo"
													<tr>
														<td colspan='2' style='text-align:center;'>".tgltoview($val['credits_acquittance_date'])."</td>
														<td style='text-align:right;'>".nominal($val['credits_acquittance_principal'])."</td>
														<td style='text-align:right;'>".nominal($val['credits_acquittance_interest'])."</td>
														<td style='text-align:right;'>".nominal($val['credits_acquittance_fine'])."</td>
														<td style='text-align:right;'>".nominal($val['credits_acquittance_penalty_amount'])."</td>
														<td colspan='2' style='text-align:right;'>".nominal($val['credits_acquittance_amount'])."</td>
													</tr>
												";
												$no++;
											}
