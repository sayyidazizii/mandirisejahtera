						...
						<div class="row">
							<div class="col-md-6">
								<table class="table table-striped table-bordered table-hover table-full-width">
									...
									<tr>
										<td width="35%">Nama Lengkap (sesuai KTP) <span class="required">*</span></td>
										<td width="5%">:</td>
									...
									<tr>
										<td width="35%">Nama Panggilan <span class="required">*</span></td>
										<td width="5%">:</td>
									...
									<tr>
										<td width="35%">Alamat (sesuai KTP)<span class="required">*</span></td>
										<td width="5%"></td>
									...
									<tr>
										<td width="35%">Alamat Tinggal Sekarang<span class="required">*</span></td>
										<td width="5%"></td>
									...
									<tr>
										<td width="35%">Status Pernikahan<span class="required">*</span></td>
										<td width="5%">:</td>
										<td width="60%">
											<?php 
									...
									<tr>
										<td width="35%">Nomor Hp<span class="required">*</span></td>
										<td width="5%">:</td>
									...
									<tr>
										<td width="35%">Iuran Wajib Keanggotaan</td>
										<td width="5%">:</td>
										<td width="60%">
											<?php 
									...
									<tr>
										...
										<td width="5%"></td>
										<td width="60%">
											<input type="text" class="easyui-textbox" name="member_class_mandatory_savings_view" id="member_class_mandatory_savings_view" autocomplete="off" value="<?php echo set_value('member_class_mandatory_savings_view',nominal($coremember['member_class_mandatory_savings']));?>" style="width:100%;"/>
									...
									<tr>
										<td width="35%">Iuran Wajib Perusahaan</td>
										<td width="5%">:</td>
										<td width="60%">
											<?php 
												echo form_dropdown('company_id', $corecompany, set_value('company_id',$coremember['company_id']),'id="company_id" class="easyui-combobox" style="width:100%;"');
											?>
									...
									<tr>
										...
										<td width="5%"></td>
										<td width="60%">
											<input type="text" class="easyui-textbox" name="member_company_mandatory_savings_view" id="member_company_mandatory_savings_view" autocomplete="off" value="<?php echo set_value('member_company_mandatory_savings_view',nominal($coremember['member_company_mandatory_savings']));?>" style="width:100%;"/>
											<input type="hidden" class="easyui-textbox" name="member_company_mandatory_savings" id="member_company_mandatory_savings" autocomplete="off" value="<?php echo set_value('member_company_mandatory_savings',$coremember['member_company_mandatory_savings']);?>" style="width:100%;"/>
										</td>
									</tr>
									<tr>
									...
									<tr>
										<td width="35%">Status Rumah<span class="required">*</span></td>
										<td width="5%">:</td>
										<td width="60%">
											<?php 
									...
									<tr>
										<td width="35%">Lama Menetap<span class="required">*</span></td>
										<td width="5%">:</td>
									...
									<!-- <tr>
										<td width="35%">Kendaraan yang Dimiliki<span class="required">*</span></td>
										<td width="5%">:</td>
										<td width="60%">
											<?php 
									...
									<tr>
										<td width="35%">Pendidikan Terakhir<span class="required">*</span></td>
										<td width="5%">:</td>
										<td width="60%">
											<?php 
									...
									<!-- <tr>
										<td width="35%">Pengguna Unit<span class="required">*</span></td>
										<td width="5%">:</td>
										<td width="60%">
											<?php 
									...
									<tr>
										<td width="35%">Nama Pengampu<span class="required">*</span></td>
										<td width="5%">:</td>
									...
									<tr>
										<td width="35%">Email<span class="required">*</span></td>
										<td width="5%">:</td>
							...
							<div class="col-md-6">
								<table style="width:100%">
									...
									<tr>
										<td width="35%">Tipe Pekerjaan Pemohon<span class="required">*</span></td>
										<td width="5%">:</td>
										<td width="60%">
											<?php 
