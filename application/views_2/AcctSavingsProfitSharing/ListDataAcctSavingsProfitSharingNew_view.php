...
<script type="text/javascript">
	$(document).ready(function(){
        $("#Save").click(function(){
				...
				alert("Apakah Anda Yakin Akan Memproses Jasa ??");
				return true;			
...
<h3 class="page-title">
	Hasil Perhitungan Jasa Simpanan
</h3>
<?php 
				...
				<div class="form-body">
						...
						<tbody>
							<?php
								...
								if(empty($acctsavingsprofitsharingtemp)){
									echo "
										<tr>
											<td colspan='11' align='center'>Jasa Belum Dihitung</td>
										</tr>
									";
								} else {
					...
					<div class="row">
						<div class="form-actions right">
							...
							<a href="<?php echo base_url(); ?>savings-profit-sharing/recalculate/<?php echo $period; ?>" class="btn btn-md red"><i class="fa fa-refresh"></i> Hitung Ulang</a>
