...
<script>
	...
	function receivedamount(){
		...
		// var by_notaris 		= document.getElementById("credit_account_notaris").value;
		// var by_asuransi 	= document.getElementById("credit_account_insurance").value;
		...
		var terima_bersih 	= parseFloat(pinjaman) - (parseFloat(by_admin) + parseFloat(by_provisi));

		// console.log(pinjaman);
		// console.log(by_admin);
		// console.log(by_notaris);
		// console.log(by_asuransi);
		// console.log(by_provisi);
		// console.log(terima_bersih);
