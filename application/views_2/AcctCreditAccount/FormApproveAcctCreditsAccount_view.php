					...
					<div class="row">
						<div class="col-md-5">
							<table style="width: 100%;" border="0" padding="0">
								...
								<!-- <tr>
									<td width="35%">Persetujuan<span class="required">*</span></td>
									<td width="5%">:</td>
									<td width="60%"><?php echo form_dropdown('credits_approve_status', $approvalstatus, set_value('credits_approve_status',$acctcreditsaccount['credits_approve_status']),'id="member_character" class="easyui-combobox" style="width: 80%"');?></td>
								</tr> -->
							</table>
						</div>
