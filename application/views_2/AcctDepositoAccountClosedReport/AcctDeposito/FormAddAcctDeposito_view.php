...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>AcctDeposito">
				Daftar Kode Deposito
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
		<li>
			<a href="<?php echo base_url();?>deposito/add">
				Tambah Kode Deposito 
			</a>
		</li>
	</ul>
</div>
						...
						<div class="row">						
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
									...
									<label class="control-label">Kode Deposito<span class="required">*</span></label>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
