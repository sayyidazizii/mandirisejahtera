...
<script type="text/javascript">
	...
	function reset_search(){
		document.location = base_url +"credits-acquittance/reset";
	}
</script>
<div class="row-fluid">
...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>credits-acquittance">
				Daftar Pelunasan Pinjaman
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
	</ul>
...
?>	
<?php	echo form_open('credits-acquittance/filter',array('id' => 'myform', 'class' => '')); 
	...
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="<?php echo base_url();?>credits-acquittance/add" class="btn btn-default btn-sm">
				...
				<div class="form-body">
					...
					<thead>
						<tr>
							...
							<th width="10%">Pelunasan Sisa Pokok</th>
							<th width="10%">Pelunasan Sisa Jasa</th>
							<th width="10%">Pelunasan Akm. Sanksi</th>
							<th width="10%">Jumlah Pinalti</th>
							<th width="10%">Total Pelunasan</th>
...
$(document).ready(function() {
    ...
    table = $('#myDataTable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('credits-acquittance/get-credits-acquittance')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 
