...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Koperasi Mandiri Sejahtera</title>
            ...
            <div class="row bs-reset">
                ...
                <div class="col-md-6 login-container bs-reset mt-login-5-bsfix">
                    <div class="login-content">
                       ...
                       <!--  <h1>FIRST <br>Financing Integrated System</h1> -->
                       <br>
                       <br>
                       <br>
                       <br>
                       ...
                       <br>
                        ...
                        <form action="<?php echo base_url();?>ValidationProcess/loginValidate" class="login-form" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6">
                                    <input class="form-control form-control-solid placeholder-no-fix form-group" type="password" autocomplete="off" placeholder="Sandi" name="password" required/> </div>
                            </div>
                            <div class="row">
