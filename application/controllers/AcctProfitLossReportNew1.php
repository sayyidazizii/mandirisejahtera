...
<?php
	Class AcctProfitLossReportNew1 extends CI_Controller{
		...
		public function index(){
			...
			// $account_subtotal 	= $this->AcctProfitLossReportNew1_model->getAccountAmount(636, 02,02, 24,1, 2);
			// var_dump($account_subtotal);
			// exit;
		...
		public function processPrinting(){
			    ...
			    <tr>
			    	...
			    	<td style=\"border:1px black solid;\">
			    		<table id=\"items\" width=\"100%\" cellspacing=\"1\" cellpadding=\"2\" border=\"0\">
							...
							<tr>
								<td style=\"width: 75%\"><div style=\"font-weight:bold;font-size:14px\">PAJAK PPH Pasal 29 Badan</div></td>
			...
			//     <tr>
			//     	<td width=\"40%\"><div style=\"text-align: center;\"></div></td>
			//         <td width=\"20%\"><div style=\"text-align: center;\"></div></td>
			//         <td width=\"40%\"><div style=\"text-align: center;font-size:12px\">".$this->AcctProfitLossReportNew1_model->getBranchCity($data['branch_id']).", ".date('d-m-Y')."</div></td>
			//     </tr>
			//     <tr>
			//         <td width=\"40%\" height=\"90px\"><div style=\"text-align: center;font-size:12px\">Yang Melaporkan</div></td>
			//         <td width=\"20%\"><div style=\"text-align: center;\"></div></td>
			//         <td width=\"40%\" height=\"90px\"><div style=\"text-align: center;font-size:12px\">Manajer</div></td>
			//     </tr>
			//     <tr>
			//         <td width=\"40%\"><div style=\"text-align: center;font-size:12px;font-weight:bold\">ADMIN</div></td>
			//         <td width=\"20%\"><div style=\"text-align: center;\"></div></td>
			//         <td width=\"40%\"><div style=\"text-align: center;font-size:12px;font-weight:bold\">".strtoupper($this->AcctProfitLossReportNew1_model->getBranchManager($data['branch_id']))."</div></td>
			//     </tr>				
			// </table>
			...
			if(!empty($acctprofitlossreport_top && $acctprofitlossreport_bottom)){
				...
				foreach($acctprofitlossreport_top as $keyTop => $valTop){
					if(is_numeric($keyTop)){
						...
						if($valTop['report_type'] == 1){
							...
							$this->excel->getActiveSheet()->setCellValue('B'.$j, '('.$valTop['account_code'].') '.$valTop['account_name']);
				...
				foreach($acctprofitlossreport_bottom as $keyBottom => $valBottom){
					if(is_numeric($keyTop)){
						...
						if($valBottom['report_type'] == 1){
							$this->excel->getActiveSheet()->mergeCells("B".$j.":C".$j."");
							$this->excel->getActiveSheet()->setCellValue('B'.$j, '('.$valBottom['account_code'].') '.$valBottom['account_name']);
						}
