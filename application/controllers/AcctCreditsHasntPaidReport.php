	...
	Class AcctCreditsHasntPaidReport extends CI_Controller{
		...
		public function processPrinting($sesi){
			...
			<table cellspacing=\"0\" cellpadding=\"1\" border=\"0\" width=\"100%\">
			    <tr>
			        ...
			        <td width=\"7%\"style=\"border-bottom: 1px solid black;border-top: 1px solid black\"><div style=\"text-align: center;font-size:9;\">Denda Bulan Ini</div></td>
			...
			if(($Keterlambatan >= 1) && ($status == 0)){
					$tbl3 .= "
						<tr>
					        ...
					        <td width=\"8%\"><div style=\"text-align: right;\">".number_format($val['credits_account_principal_amount'], 2)."</div></td>
					       	...
					       	<td width=\"7%\"><div style=\"text-align: right;\">".number_format($credits_payment_fine_amount, 2)."</div></td>
				...
				$totaldenda			+= $credits_payment_fine_amount;
		...
		public function export($sesi){	
			...
			if(count($acctcreditsaccount) !=0){
				...
				$this->excel->getActiveSheet()->setCellValue('K3',"Denda Bulan Ini");
				...
				foreach($acctcreditsaccount as $key=>$val){
					...
					if(is_numeric($key)){
						...
						$this->excel->getActiveSheet()->setCellValue('K'.$j, number_format($credits_payment_fine_amount,2));
