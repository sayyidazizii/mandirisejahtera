	...
	Class AcctCashPayments extends CI_Controller{
		...
		public function addCashlessPayment(){	
			...
			$data['main_view']['saving_account'] = "";
				...
				$total			= ceil($creditaccount['credits_account_payment_amount']/1000)*1000;
				$interest_plus	= $total - $creditaccount['credits_account_payment_amount'];
		...
		public function AcctCashPaymentsProcess(){
			...
			// var_dump($credits_payment_to);exit;
