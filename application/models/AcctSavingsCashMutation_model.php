<?php
	...
	class AcctSavingsCashMutation_model extends CI_Model {
		...
		public function getAcctSavingsCashMutation($start_date, $end_date, $savings_account_id){
		...
		public function validationAcctSavingsCashMutation($data){
		...
		public function voidAcctSavingsCashMutation($data){
			$this->db->where("savings_cash_mutation_id",$data['savings_cash_mutation_id']);
			$query = $this->db->update($this->table, $data);
			if($query){
				return true;
		...
		public function getAcctSavingsCashMutation_Member($member_id, $savings_cash_mutation_date, $data_mutation){
