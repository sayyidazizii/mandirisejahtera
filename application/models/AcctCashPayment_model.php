<?php
	...
	class AcctCashPayment_model extends CI_Model {
		...
		function get_datatables($start_date, $end_date, $credits_id, $branch_id, $type)
	    {
	        $this->_get_datatables_query($start_date, $end_date, $credits_id, $branch_id, $type);
	    ...
	    function count_filtered($start_date, $end_date, $credits_id, $branch_id, $type)
	    {
	        $this->_get_datatables_query($start_date, $end_date, $credits_id, $branch_id, $type);
	        $query = $this->db->get();
	    ...
	    public function count_all($start_date, $end_date, $credits_id, $branch_id, $type)
	    {
			...
			$this->db->where('acct_credits_payment.credits_payment_type', $type);
		...
		private function _get_datatables_query($start_date, $end_date, $credits_id, $branch_id, $type)
	    {
