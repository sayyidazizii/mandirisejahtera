<?php
	...
	class AcctSavingsAccount_model extends CI_Model {
		...
		public function getAcctSavingsAccount($start_date, $end_date, $savings_id, $branch_id){
		...
		public function getAcctSavingsDetail($savings_id){
			$this->db->select('savings_id, savings_name');
			$this->db->from('acct_savings');
			$this->db->where('data_state', 0);
			$this->db->where('savings_status', 0);
			$this->db->where('savings_id', $savings_id);
			return $this->db->get()->row_aray();
		}
		...
		public function getAcctSavingsAccount_Last($created_on){
		...
		public function getAcctSavingsAccount_Detail($savings_account_id){
			$this->db->select('acct_savings_account.savings_account_id, acct_savings_account.member_id, core_member.member_name, core_member.member_no, core_member.member_gender, core_member.member_address, core_member.member_phone, core_member.member_date_of_birth, core_member.member_identity_no, core_member.city_id, core_member.kecamatan_id, core_member.identity_id,core_member.branch_id, core_member.member_job, acct_savings_account.savings_id, acct_savings.savings_code, acct_savings.savings_name, acct_savings_account.savings_account_no, acct_savings_account.savings_account_date, acct_savings_account.savings_account_first_deposit_amount, acct_savings_account.savings_account_last_balance, acct_savings_account.voided_remark, acct_savings_account.validation, acct_savings_account.validation_on, acct_savings_account.validation_id, acct_savings_account.office_id');
			$this->db->from('acct_savings_account');
			$this->db->join('core_member', 'acct_savings_account.member_id = core_member.member_id');
			$this->db->join('acct_savings', 'acct_savings_account.savings_id = acct_savings.savings_id');
			$this->db->where('acct_savings_account.data_state', 0);
		...
		public function voidAcctSavingsAccount($data){
		...
		public function validationAcctSavingsAccount($data){
			$this->db->where("savings_account_id",$data['savings_account_id']);
			$query = $this->db->update($this->table, $data);
			if($query){
				return true;
